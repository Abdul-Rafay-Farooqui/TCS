    ...
    <div className={`r-transition bg-tcs-black rounded-[35px]`}>
      ...
      <div className="hidden xl:block relative ">
        <img
          ...
          src="https://firebasestorage.googleapis.com/v0/b/tcs-website-edf68.appspot.com/o/Swiggle_1.gif?alt=media&token=1eb0c91c-306a-49dd-ae19-a34a3af04b69"
        />
      </div>
      <>
        {/* Second Service */}
        ...
        <div className="hidden xl:block relative ">
          <img
            ...
            src="https://firebasestorage.googleapis.com/v0/b/tcs-website-edf68.appspot.com/o/Star%202.gif?alt=media&token=60dda11b-39fe-4dfa-bac3-b3f2bb841448"
          />
        </div>
        {/* Third Service */}
        ...
        <div className="hidden xl:block relative ">
          <img
            loading="lazy"
            className="r-transition absolute hover:scale-110 size-[190px] top-5 right-10"
            src="https://firebasestorage.googleapis.com/v0/b/tcs-website-edf68.appspot.com/o/Circle.gif?alt=media&token=1add54b7-c7bd-4f2e-8c47-20c1f9c11b62"
          />
        </div>
        {/* Fourth Service */}
